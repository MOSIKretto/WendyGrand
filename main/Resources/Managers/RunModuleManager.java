...
public class RunModuleManager 
{
    ...
    private static void handleRCModule(String compiler, String modulePath, String currentDirectory) throws 
    InterruptedException, 
    IOException
    {
    ...
    private static void handleJavaScriptModule(String modulePath, String currentDirectory) throws 
    InterruptedException, 
    IOException
    {
    ...
    private static List<String> extractLibFromPy(String modulePath) throws 
    IOException 
    {
    ...
    private static void installLibsForPy(String venvPath, List<String> libraries) throws 
    InterruptedException, 
    IOException
    {
    ...
    private static boolean isLibInstalledInVenv(String venvPath, String library) throws 
    InterruptedException, 
    IOException
    {
        String pipExecutable = Paths.get(venvPath, "bin", "pip").toString();
