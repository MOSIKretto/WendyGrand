...
**WendyGrand** - инновационный проект, разработанный для помощи новичкам в мире Linux и автоматизации повседневных задач. WendyGrand предоставляет базовый набор функций, расширяемый с помощью модулей. Основной код проекта написан на **Java** и **Python**.
...
Для запуска WendyGrand выполните в терминале:

```bash
cd /путь/к/WendyGrand
./Start.sh
```

Скрипт автоматически установит зависимости и скомпилирует необходимые модули.
