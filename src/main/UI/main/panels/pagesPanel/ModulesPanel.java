...
import src.main.UI.main.components.CustomDivider;
...
public class ModulesPanel extends JPanel 
{
    ...
    public ModulesPanel(WindowMaker window) 
    {
        ...
        {
            @Override
            public void focusGained(FocusEvent e) { window.setCurrentFocusState(FocusState.MODULES_LIST); }
        });
    }
    ...
    private void initUI() 
    {
        ...
        {
            @Override
            public BasicSplitPaneDivider createDefaultDivider() { return new CustomDivider(this); }
        });
    ...
    private JPanel createModulesListPanel() 
    {
        ...
        modulesList.addListSelectionListener(e -> { if (!e.getValueIsAdjusting()) loadModuleConfig(); });
    ...
    private void setupEditorKeyBindings(JTextArea editor) 
    {
        ...
        {
            @Override
            public void actionPerformed(ActionEvent e) { modulesList.requestFocusInWindow(); }
        });
        
        am.put("returnToMenu", new AbstractAction() 
        {
            @Override
            public void actionPerformed(ActionEvent e) { window.focusOnPanel("MainMenu"); }
        });
    }
    ...
    private void setupKeyBindings()
    {
        ...
        {
            @Override
            public void actionPerformed(ActionEvent e) { configArea.requestFocusInWindow(); }
        });
    }
    ...
    public void focusOnList() 
    {
        if (modulesList != null) 
        {
            ...
            if (modulesList.getSelectedIndex() == -1 && modulesList.getModel().getSize() > 0) modulesList.setSelectedIndex(0);
        }
    }
}