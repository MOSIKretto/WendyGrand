...
{
    private final Path HIST_FILE = Paths.get("settings/configs", "History.conf"); // Потом заменить
    ...
    public void startFileWatcher() 
    {
        Thread watcherThread = new Thread(() -> {
            ...
            catch (Exception e) { System.err.println("Ошибка мониторинга файла: " + e.getMessage()); }
        });
