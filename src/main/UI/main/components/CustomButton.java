...
public class CustomButton extends JButton
{
    ...
    private void setupButton(int button_weidht, int button_height) 
    {
        ...
        if (button_height > 0 && button_weidht > 0) setPreferredSize(new Dimension(button_weidht, button_height));
    ...
    protected void paintComponent(Graphics g) 
    {
        ...
        if (getModel().isPressed()) color = pressedColor;
        else if (getModel().isRollover()) color = hoverColor;
