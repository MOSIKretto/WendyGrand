...
public abstract class UniversalDictionaryPanel extends JPanel 
{
    ...
    private void loadDictionary() 
    {
        ...
        catch (IOException e) { dictionaryArea.setText("Ошибка загрузки " + dictionaryName + ": " + e.getMessage()); }
    }
    ...
    private void saveDictionary(ActionEvent e) 
    {
        ...
        catch (IOException ex) { JOptionPane.showMessageDialog(this, "Ошибка сохранения " + dictionaryName + ": " + ex.getMessage()); }
    }
}