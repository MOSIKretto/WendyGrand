...
public class UIUtils 
{
    ...
    public static JButton createControlButton(String type, ActionListener action) 
    {
        JButton btn = new JButton() {
            ...
            protected void paintComponent(Graphics g) 
            {
                ...
                if (type.equals("minimize")) g2.drawLine(centerX - 6, centerY, centerX + 6, centerY);
                else 
                {
    ...
    public static void styleTextArea(JTextArea textArea, Color caretColor, int blinkRate, int caretWidth, boolean highlightLine, Color highlightColor) 
    {
        ...
        if (highlightLine) 
        {
            Color lineColor = highlightColor != null ? highlightColor : new Color(100, 100, 255, 50); 
    ...
    private static void styleScrollBar(JScrollBar scrollBar) 
    {
        ...
        {
            public void mouseEntered(java.awt.event.MouseEvent evt) { scrollBar.setBackground(new Color(80, 80, 80)); }
            public void mouseExited(java.awt.event.MouseEvent evt) { scrollBar.setBackground(new Color(40, 40, 40)); }
        });
    }
}